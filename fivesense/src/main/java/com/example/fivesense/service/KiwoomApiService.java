...
public class KiwoomApiService {
    ...
    public KiwoomApiService(SimpMessagingTemplate messagingTemplate) {
        ...
        this.webClient = WebClient.builder()
                ...
                .defaultHeader("appkey", "b2K5-UsTjlm6ZzCoOpYXfoW7w-f9lIoiCyJPfWbOvjA")//apikey 값 가져오기(현재  application.properties에 있는 값을 못가져와서 뒷부분에 값을 하드코딩해야함함)
                .defaultHeader("appsecret", "F9011bD31_BQEry1SOorhTUSGAj-mEOjrfjQZc4AD9A")//apiSecret 값 가져오기
                .build();
    ...
    private void getAccessToken() {
        try {
            ...
            tokenRequest.put("appkey", "b2K5-UsTjlm6ZzCoOpYXfoW7w-f9lIoiCyJPfWbOvjA");//apikey 값 가져오기(현재  application.properties에 있는 값을 못가져와서 뒷부분에 값을 하드코딩해야함함)
