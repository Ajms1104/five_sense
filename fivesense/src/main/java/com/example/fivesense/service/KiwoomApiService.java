...
public class KiwoomApiService {
    ...
    public KiwoomApiService(SimpMessagingTemplate messagingTemplate) {
        ...
        this.webClient = WebClient.builder()
                ...
                .defaultHeader("appkey", "eZZzIWfyu3tBkon3ne2HxtPq8M99DjpRuo45FeWVwBU")
                .defaultHeader("secretkey", "KUsDPZZYkx57EG-fOhQNKrOrdis6c2q8PFBpgL3Gew0")
                .build();
    ...
    private void getAccessToken() {
        try {
            ...
            tokenRequest.put("appkey", "eZZzIWfyu3tBkon3ne2HxtPq8M99DjpRuo45FeWVwBU");
            tokenRequest.put("secretkey", "KUsDPZZYkx57EG-fOhQNKrOrdis6c2q8PFBpgL3Gew0");
