...
set JARPATH=%APP_HOME%\lib\fivesense-0.0.1-SNAPSHOT.jar

@rem Execute fivesense
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %FIVESENSE_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%FIVESENSE_EXIT_CONSOLE%" exit 1
exit /b 1
